...
<script src="js/demo/tables-footable.js"></script>
  ...
  <div id="content-container">
                ...
                <div id="page-content">
                    ...
                    <div class="row">
					    <div class="col-lg-10">
					    	<embed src="/CivilServiceExamination/img/banner.swf" width="100%" height="230px"></embed>
					    </div>
					    <div class="col-lg-2">
					    <!--Small weather widget-->
					        ...
					        <div class="panel text-center">
					            <div class="pad-all bg-warning">
					                <img alt="rain" src="/CivilServiceExamination/img/rain.png"  width="128" height="128">
						    ...
						    <div class="panel-body">
						        <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
						            ...
						            <c:forEach var="p" items="${allCom}">
						                <tr>
						                    <td><a target="_blank" href="/CivilServiceExamination/share/${p.id}">${p.name}</a></td>
						                    <td>${p.ps}</td>
