          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/CivilServiceExamination/game/doAddCompetion" method="post">

                      <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail2">公务员考试批次名称</label>
					                        <div class="col-sm-9">
					                            <input type="text" id="demo-hor-inputemail2" class="form-control" name="name" value="" required="required">
					                        </div>
					                    </div>
					                    
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail2">本次公务员考试描述</label>
					                        <div class="col-sm-9">
					                            <textarea rows="8" id="demo-hor-inputemail2" class="form-control" name="ps" required="required"></textarea>
					                        </div>
					                    </div>
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail4">公务员考试开始时间</label>
					                        <div class="col-sm-9">
					                            <input type="datetime-local" id="demo-hor-inputemail4" class="form-control" name="fromTime"  required="required" value="2017-06-05T12:20">
					                        </div>
					                    </div>
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail5">公务员考试结束时间</label>
					                        <div class="col-sm-9">
					                            <input type="datetime-local" id="demo-hor-inputemail5" class="form-control" name="toTime" required="required" value="2017-06-05T14:20">
					                        </div>
					                    </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success">提交公务员考试信息</button>
                        </div>
                      </div>
