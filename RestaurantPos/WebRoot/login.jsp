...
<link href="assets/admin/pages/css/login2.css" rel="stylesheet"
	type="text/css" />
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="/RestaurantPos/login" method="post">
		<div class="form-title">
			<span class="form-title">欢迎使用本系统</span>
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" placeholder="用户名" name="loginName" required/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
			<input class="form-control form-control-solid placeholder-no-fix" type="password" placeholder="密码" name="loginPass" required/>
		</div>
		...
		<div class="form-actions">
			<div class="pull-left">
				...
				<input type="checkbox" name="remember" value="1" checked="checked" />记住用户名 </label>
			</div>
		...
		<div class="create-account">
			<p>
				<a href="javascript:;" id="register-btn">我要新建一个账户</a>
			</p>
		</div>
	</form>
	<!-- END LOGIN FORM -->
	...
	<form class="forget-form" action="index.html" method="post">
		<div class="form-title">
			<span class="form-title">请联系管理员</span>
			<span class="form-subtitle"></span>
		</div>
		<div class="form-group">
			<input class="form-control placeholder-no-fix" type="text" value="448740780@qq.com" readonly="readonly"/>
		</div>
		<div class="form-actions">
			<button type="button" id="back-btn" class="btn btn-default">返回</button>
			<button type="submit" class="btn btn-primary uppercase pull-right"></button>
		</div>
	</form>
