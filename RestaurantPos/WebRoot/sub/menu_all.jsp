					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									 <a href="/RestaurantPos/menu/update/${p.id}" class="btn default btn-xs purple" target="r">
										<i class="fa fa-edit"></i> 修改 </a>
										
									 <a href="/RestaurantPos/menu/del/${p.id}" class="btn default btn-xs black" target="r">
