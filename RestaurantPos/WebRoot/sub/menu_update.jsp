    ...
    <!-- BEGIN PAGE HEADER-->
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>修改菜品的信息 <small>修改修改菜品的信息请点击提交修改</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase">修改菜品的信息</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							<form role="form" method="post" action="/RestaurantPos/menu/doUpdate">
								<div class="form-body">
									...
									<div class="form-group form-md-line-input form-md-floating-label">
										<textarea class="summernote" id="contents" name="content" required>${menu.content}</textarea>
									</div>
