    ...
    <div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>这是本桌当前所选菜品 <small>如果无误请下单，递交到后厨</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
				...
				<div class="portlet light bordered">
									...
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">当前点餐信息一览</span>
									...
									<form action="/RestaurantPos/res/search" class="form-horizontal" method="post">
										<!-- BEGIN FORM-->
											<div class="form-body">
												...
												<div class="form-group">
													<label class="col-md-3 control-label">当前订单价格</label>
													<div class="col-md-4">
													
														<input type="text" id="demo-hor-inputemail4" class="form-control" required="required" value="${orderFlag.sumPrice}￥">
													</div>
												</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<a class="btn green" href="/RestaurantPos/order/action/${orderFlag.id}"> 下单 </a>
													</div>
												</div>
											</div>
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								...
								<c:if test="${orderFlag.tableId != null}">
									所选菜品列表
								</c:if>
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									 <img alt="图片未设置" src="${p.photo}" style="width: 100px;">
								</td>
								<td>
									 ${p.price}
								</td>
								<td>
										<a href="/RestaurantPos/order/dels/${p.id}" class="btn btn-danger" target="r">
											<i class="fa fa-edit"></i> 删除 此菜品
										</a>
