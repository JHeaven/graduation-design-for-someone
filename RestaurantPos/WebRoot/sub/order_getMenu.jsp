					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								...
								<c:if test="${orderFlag.tableId != null}">
									当前为席位【${orderFlag.tableId}】${orderFlag.tableName} 点餐
								</c:if>
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<c:if test="${orderFlag.tableId != null}">
										<a href="/RestaurantPos/order/xuan/${p.id}" class="btn btn-danger" target="r">
											<i class="fa fa-edit"></i> 选定 
										</a>
									</c:if>
									
									<c:if test="${orderFlag.tableId == null}">
										<a class="btn default btn-xs red" target="r">
											<i class="fa fa-edit"></i> 请先选择席位
										</a>
									</c:if>
