...
<body>
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>新增餐桌的信息 <small>修改新增餐桌的信息请点击提交修改</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase">以下为新增餐桌的信息</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							<form role="form" method="post" action="/RestaurantPos/table/doAdd">
								<div class="form-body">
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="text" class="form-control" name="name" value="">
										<label for="form_control_1">新增餐桌的名称</label>
										<span class="help-block">这是新增餐桌的名称。</span>
									</div>
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="text" class="form-control" name="people" value="${table.people}">
										<label for="form_control_1">新增餐桌的容纳人数</label>
										<span class="help-block">这是新增餐桌的容纳人数。</span>
									</div>
									...
									<div class="form-group form-md-line-input form-md-floating-label has-info">
										...
										<label for="form_control_1">新增餐桌的性质</label>
									</div>
