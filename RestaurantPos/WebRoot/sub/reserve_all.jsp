					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									 <a href="/RestaurantPos/res/update/${p.id}" class="btn default btn-xs purple" target="r">
										<i class="fa fa-edit"></i> 修改 </a>
										
									 <a href="/RestaurantPos/res/del/${p.id}" class="btn default btn-xs black" target="r" onclick="if(confirm('确定删除?')==false)return false;">
