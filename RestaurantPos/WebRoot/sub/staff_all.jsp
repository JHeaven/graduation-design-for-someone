				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<c:forEach var="p" items="${allStaff}">
							...
							<tr>
								...
								<td>
									 <fmt:formatDate value="${p.enterTime}" type="date"/>
								</td>
								<td>
									 ${p.age}
								</td>
								<td>
									 <a href="/RestaurantPos/staff/myProfle/${p.id}" class="btn default btn-xs purple" target="r">
										<i class="fa fa-edit"></i> 修改 </a>
										
									 <a href="/RestaurantPos/staff/del/${p.id}" class="btn default btn-xs black" target="r">
