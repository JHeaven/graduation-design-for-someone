...
<body>
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>修改预定的信息 <small>修改修改预定的信息请点击提交修改</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase">如果要修改桌次和时间请删除预定，重新选取时间，并挑选餐桌。</span>
							</div>
							<div class="actions">
						...
						<div class="portlet-body form">
							<form role="form" method="post" action="/RestaurantPos/res/doupdate">
								<div class="form-body">
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="text" class="form-control" name="name" value="${res.name}">
										<input type="hidden" class="form-control" name="id" value="${res.id}">
										<label for="form_control_1">修改联系人姓名</label>
										<span class="help-block">这是修改预定的联系人姓名。</span>
									</div>
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="text" class="form-control" name="phone" value="${res.phone}">
										<label for="form_control_1">修改预定的联系人电话</label>
										<span class="help-block">这是修改预定的联系人电话。</span>
									</div>
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="number" class="form-control" name="deleted" value="${res.deleted}">
										<label for="form_control_1">修改预定的来客人数</label>
										<span class="help-block">这是修改预定的来客人数。</span>
									</div>
									
									
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="text" class="form-control" name="content" value="${res.content}">
										<label for="form_control_1">修改备注</label>
										<span class="help-block">这是修改备注。</span>
									</div>
