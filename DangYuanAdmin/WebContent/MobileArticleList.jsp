...
<div id="loader-wrapper">
	...
	<div id="wrap" class="xialadaodibu">
    
    <div class="content">
        <div class="post">
            <div class="post-item">
                <h2><a href="#">请拉到页面底部，以获取更多内容。</a></h2>
                <div class="post-image"><img src="pic/1000.png" alt="Img"></div>
	...
	<div id="wrap" class="shaodeng" style="display:none;">
    
    <div class="content">
        <div class="post">
            <div class="post-item">
                <h2><a href="#">请稍等，当前正在加载数据·····</a></h2>
                <div class="post-image"><img src="pic/1000.png" alt="Img"></div>
                <p><a href="http://182.254.145.144/home/">©Designed by: 蒋宇钦</a></p>
            </div>
	...
	<script>
		var pageNo = 0;
		var belong = "${requestScope.belong}";
		...
		function gotoNewActivity(url){
			return window.nativeMethod.toActivity(url);
		};
	</script>
