					...
					<div class="row">
					    ...
					    <div class="col-sm-12">
					        <div class="panel">
					            ...
					            <!--Horizontal Form-->
					            <!--===================================================-->
					            <form id="myform" class="form-horizontal" method="post" action="/TextbookReservation/stu/doUpdate">
					                <div class="panel-body">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail1">教师工号</label>
					                        <div class="col-sm-9">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail5">入职日期</label>
					                        <div class="col-sm-9">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail9">所属院(系、部)</label>
					                        <div class="col-sm-9">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail11">所属专业</label>
					                        <div class="col-sm-9">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail12">带领班级</label>
					                        <div class="col-sm-9">
					                    ...
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputemail13">我的登录名</label>
					                        <div class="col-sm-9">
