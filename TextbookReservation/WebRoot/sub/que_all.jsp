  ...
  <div id="container" class="effect aside-float aside-bright mainnav-lg">
	  <div class="boxed">
		  ...
		  <!--Page Title-->
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">问题答疑</h1>
					        ...
					        <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
					            ...
					            <c:forEach var="p" items="${allQue}">
					                <tr>
					                    ...
					                    <td>${p.ans}</td>
					                    <td>
						                	<a class="btn btn-danger" target="right" href="/TextbookReservation/que/ansQue/${p.id}">答疑</a>
						                	<a class="btn btn-danger" target="right" href="/TextbookReservation/que/delQueAdmin/${p.id}">删除</a>
					                    </td>
					                </tr>
