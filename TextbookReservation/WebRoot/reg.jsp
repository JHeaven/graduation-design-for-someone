		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
		                <h1 class="h1 mar-no">黑龙江工程学院<br>教材预定系统</h1><br>
		                <p class="text-muted">请注册<span style="color: red;">${message}</span></p>
		            </div>
		            <form action="/TextbookReservation/stu/reg" method="post" autocomplete="off">
		                ...
		                <div class="form-group">
		                    <input type="password" class="form-control" placeholder="输入工号" name="stuId">
		                </div>
		        ...
		        <div class="pad-all">
		            ...
		            <a href="http://localhost:8080/TextbookReservation/" class="btn-link mar-lft">返回登陆页面</a>
