          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>查看档案<span style="color: red;">${message1}</span></h2>
                      ...
                      <c:forEach var="s" items="${allStaff}">
                        <tr>
                          ...
                          <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="btn-group">
		                    <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">操作 <span class="caret"></span>
		                    </button>
		                    <ul role="menu" class="dropdown-menu">
		                      <li><a href="/HumanResourceManagement/check/addToCheck/${s.id}" target="right">开始培训</a>
		                      </li>
		                      <li><a href="/HumanResourceManagement/staff/goToUpdate/${s.id}" target="right">修改信息</a>
		                      </li>
		                      <li><a href="/HumanResourceManagement/staff/del/${s.id}" target="right">刪除员工</a>
		                      </li>
		                    </ul>
		                    </div>
                          ...
                          <td>${s.loginName}</td>
                          <td><img alt="wait...." src="${s.photo}"> </td>
                          <td>${s.identification}</td>
                          <td>${s.enterdptDate}</td>
                          <td>${s.originalEnterprise}</td>
                          <td>${s.originalName}</td>
                          <td>${s.originalDuty}</td>
                          <td>${s.graduationSchool}</td>
