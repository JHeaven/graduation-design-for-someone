              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<c:forEach items="${allDuty}" var="duty">
                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="/HumanResourceManagement/asserts/images/media.jpg" alt="image" />
                            <div class="mask">
                              <p>${duty.name}</p>
                          ...
                          <div class="caption">
                            <p>${duty.name}</p>
                            <a type="button" class="btn btn-success btn-xs" href="/HumanResourceManagement/duty/doSelect/${staff.id}/${duty.id}" target="right">选择职称</a>
                          </div>
                        </div>
                      </div>
                      </c:forEach>
