          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>选择人员  <span style="color: red;">${message1}</span></h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <c:forEach var="s" items="${allStaff}">
                        <tr>
                          ...
                          <td>${s.hiredDepartment}</td>
                          <td>${s.telphone}</td>
                          <td>${s.email}</td>
                          <td><a type="button" class="btn btn-warning btn-xs" target="right" href="/HumanResourceManagement/dep/selectDep/${s.id}">选定</a></td>
                        </tr>
                        </c:forEach>
                      </tbody>
                    </table>
