		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						合同管理 <small>在这里你可以管理网站的合同</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li><i class="fa fa-home"></i> <a href="index.html">后台</a> <i
								...
								<tbody>
									...
									<c:forEach var="p" items="${allOrder}">
										...
										<tr class="odd gradeX">
											...
											<td class="center"><c:forEach var="pp"
													items="${p.allDetail}">
									【${pp.comName}】单价：${pp.price} 数量：<span
														class="label label-sm label-success">${pp.num}</span>件
									</c:forEach> <a class="btn btn-danger" data-toggle="modal"
												href="#wide-${p.id}"> 查看合同 </a> 
												
												
												
												<!-- /.modal -->
												<div class="modal fade" id="wide-${p.id}" tabindex="-1" role="basic"
													aria-hidden="true">
													<div class="modal-dialog modal-wide">
														<div class="modal-content">
															<div class="modal-header">
																<button type="button" class="close" data-dismiss="modal"
																	aria-hidden="true"></button>
																<h4 class="modal-title">查看ID为 ${p.id} 的合同</h4>
															</div>
															<div class="modal-body"> ${p.heTong}</div>
															<div class="modal-footer">
											...
											<td class="center">${p.ps}</td>
											<td><a href="/HouseSale/com/fahuo/${p.id}" target="r"
												class="btn btn-success"> 通过审核 </a> <br> <a
												href="/HouseSale/com/delOrder/${p.id}" target="r"
												class="btn btn-danger"> 删除合同 </a></td>
										</tr>
