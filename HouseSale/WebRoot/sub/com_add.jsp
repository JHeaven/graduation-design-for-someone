				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="/HouseSale/com/addCom">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input type="text" class="form-control" value="${userLoginFlag.userId}" name="userId" readonly="readonly">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">房型</label>
										<div class="col-md-10">
											<select name="number" class="form-control">
												<option value="1">50平以下</option>
												<option value="2">50平—70平</option>
												<option value="3">70平—90平</option>
												<option value="4">90平—110平</option>
												<option value="5">110平—130平</option>
												<option value="6">130平—150平</option>
												<option value="7">150平以上</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">房型细节</label>
										<div class="col-md-10">
