								...
								<td>
									<div class="portlet box red">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-calendar"></i>【${p.title}】  发布于：<fmt:formatDate value="${p.upTime}" type="date" dateStyle="long"/><fmt:formatDate value="${p.upTime}" type="time" timeStyle="short"/>
											</div>
											<div class="tools">
