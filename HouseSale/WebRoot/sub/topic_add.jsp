		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					发表供需信息 <small>您可以发表自己的供需信息</small>
					</h3>
				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>  发表供需信息
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="/HouseSale/topic/addTopic">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-2 control-label">供需信息内容</label>
										<div class="col-md-10">
