...
//');
	...
	$templateCache.put('angular-busy.html','\
			<div class="cg-busy-default-wrapper" style="width=100%">\
				<div style="font-size:52px;" class="fa fa-spinner fa-spin"></div>\
			</div>\
	');
...
//    "\r" +
//    "\n" +
//    "      <div style='font-size:52px;' class=\"fa fa-spinner fa-spin\">\r" +
//    "\n" +
