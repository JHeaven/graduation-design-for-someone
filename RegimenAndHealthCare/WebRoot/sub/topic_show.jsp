				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group"><a type="button"
							...
							href="/RegimenAndHealthCare/topic/goToAdd" target="r"
							style="color: white;"> <span> 发布话题 </span>
						</a></li>
						<li><i class="fa fa-home"></i> <a href="index.html">主页</a> <i
							class="fa fa-angle-right"></i></li>
						<li><a href="#">专题</a> <i class="fa fa-angle-right"></i></li>
						<li><a>所有话题</a></li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12 blog-page">
						...
						<div class="col-md-9 col-sm-8 article-block">
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									...
									<a class="btn blue" href="/RegimenAndHealthCare/topic/select/${p.id}" target="r">
									查看全文(${p.count})
					...
					<ul class="pagination pull-right">
						<li>
							<a href="/RegimenAndHealthCare/topic/showTopic/1" target="r">首页</a>
						</li>
						<li>
							<a href="/RegimenAndHealthCare/topic/showTopic/${pageNo-1}" target="r"><i class="fa fa-angle-left"></i></a>
						</li>
						<li>
							<a href="/RegimenAndHealthCare/topic/showTopic/${pageNo+1}" target="r"><i class="fa fa-angle-right"></i></a>
						</li>
						<li>
							<a href="/RegimenAndHealthCare/topic/showTopic/${pageSum}" target="r">尾页</a>
						</li>
					</ul>
				</div>
			</div>
