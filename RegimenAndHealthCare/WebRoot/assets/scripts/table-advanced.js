var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>名称：</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>操作:</td><td><a target="r" href="/RegimenAndHealthCare/com/update/'+aData[1]+'"><span class="badge badge-roundless badge-success">修改 </span></a><a target="r" href="/RegimenAndHealthCare/com/del/'+aData[1]+'"><span class="badge badge-roundless badge-danger">删除 </span></a></td></tr>';
            sOut += '</table>';
