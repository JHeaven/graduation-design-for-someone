!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade'><br><br><br><br><br><br><br><br>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade'><br><br><br><br><br><br><br>" +
               "<div class='modal-dialog'><div class='modal-content'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                  "<input value='' class='bootstrap-wysihtml5-insert-image-url form-control'><br><h4>TIPS：此处可以加入站内资源或网络图片，网络图片请附加http头</h4>" +
                "</div>" +
                "<div class='modal-footer'>" +
