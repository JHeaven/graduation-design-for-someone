			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" method="post" action="/Recruit/position/doupdate">
                                
                                 <div class="form-group">
                                    <label class="col-md-4 control-label">职位ID</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="id" value="${po.id}" />
                                    </div>
                                </div>
