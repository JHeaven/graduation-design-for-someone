			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">新闻添加</h4>
                        </div>
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" method="post" action="/Recruit/new/doadd">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="summernote" id="contents" name="content" >${news.content}</textarea>
                                    </div>
                                </div>
