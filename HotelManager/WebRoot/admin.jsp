    ...
    <div class="modal-shiftfix">
      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        <div class="container-fluid top-bar">
          ...
          <button class="navbar-toggle"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="logo" href="/HotelManager/admin">se7en</a>
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a class="current" href="/HotelManager/admin"><span aria-hidden="true" class="se7en-home"></span>主页</a>
              </li>
              <li><a href="/HotelManager/user/all" target="r">
                <span aria-hidden="true" class="se7en-feed"></span>用户管理</a>
              </li>
              <li class="dropdown"><a data-toggle="dropdown" href="#">
                <span aria-hidden="true" class="se7en-star"></span>客房管理<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <a href="/HotelManager/room/add" target="r">新增客房</a>
                  </li>
                  <li>
                    <a href="/HotelManager/room/all#zhidao" target="r">所有客房</a>
                  </li>
                  <li>
                    <a href="/HotelManager/room/allSection#zhidao" target="r">客房状态</a>
                  </li>
                </ul>
              </li>
              <li class="dropdown"><a data-toggle="dropdown" href="#">
                <span aria-hidden="true" class="se7en-forms"></span>资讯管理<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                  <a href="/HotelManager/new/add" target="r">
                    <p>
                      新增资讯
                    </p>
                    </a>
                  ...
                  <li>
                    <a href="/HotelManager/new/newsShow" target="r">所有资讯</a>
                  </li>
                </ul>
              </li>
              <li class="dropdown"><a data-toggle="dropdown" href="#">
                <span aria-hidden="true" class="se7en-tables"></span>预定管理<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <a href="/HotelManager/order/all#zhidao" target="r">查看预定</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="dropdown"><a data-toggle="dropdown" href="#">
                <span aria-hidden="true" class="se7en-charts"></span>统计分析<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li>
                    <a href="/HotelManager/charts/all#zhidao" target="r">最近统计</a>
                  </li>
                  <li>
                    <a href="/HotelManager/charts/alll#zhidao" target="r">数据分析</a>
                  </li>
              ...
              <li><a href="/HotelManager/order/allToday#zhidao" target="r">
                <span aria-hidden="true" class="se7en-gallery"></span>当前在住客房</a>
              </li>
              
              <li><a href="/HotelManager/mail/goto" target="r">
                <span aria-hidden="true" class="se7en-feed"></span>群发邮件</a>
              </li>
      ...
      <!-- End Navigation -->
      			...
      			<iframe src="/HotelManager/adminright" width="100%" height="1400px;" style="border: 0;" name="r"></iframe>
