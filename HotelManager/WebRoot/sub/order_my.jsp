        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-table"></i>您可以查看我的预定信息
              </div>
                ...
                <table class="table table-bordered table-striped" id="dataTable1">
                  ...
                  <c:forEach var="p" items="${allOrder}">
                    <tr>
                      ...
                      <td>
                      	<c:if test="${p.ps == '等待审核'}">
                      		<a href="/HotelManager/order/del/${p.id}#zhidao" target="r"><span class="label label-danger">撤销预定</span></a>
                      	</c:if>
                        <c:if test="${p.ps != '等待审核'}">
                      		<a target="r"><span class="label label-danger">如有问题<br>请您联系<br>酒店前台</span></a>
                      	</c:if>
                      </td>
