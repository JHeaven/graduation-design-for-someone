...
<html>
  <head>
    ...
    <script>
	window.location = "/HotelManager/new/newsShow#zhidao"; //自动跳转到锚点处
</script>
  </head>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-table"></i>您可以对每个资讯进行管理
              </div>
                ...
                <table class="table table-bordered table-striped" id="dataTable1">
                  ...
                  <c:forEach var="p" items="${allNews}">
                    <tr>
                      ...
                      <td>
                       <fmt:formatDate value="${p.upTime}" type="both"/>
                      ...
                      <td>
                        <a href="/HotelManager/new/del/${p.id}#zhidao" target="r"><span class="label label-danger">删除资讯</span></a>
                      </td>
