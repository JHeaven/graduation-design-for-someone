        ...
        <form action="/HotelManager/room/doupdate" class="form-horizontal" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              ...
              <input class="form-control" type="hidden" name="id" value="${room.id}">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <select name="type"  class="form-control">
              	  <option value="${room.type}">当前为：${room.type}</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <select name="hasTv"  class="form-control">
              	  <option value="${room.hasTv}">当前为：${room.hasTv}</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <select name="hasPhone" class="form-control">
              	  <option value="${room.hasPhone}">当前为：${room.hasPhone}</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
              <select name="hasAir" class="form-control">
              	  <option value="${room.hasAir}">当前为：${room.hasAir}</option>
