...
<meta
	...
	name="viewport">
<script>
	window.location = "/HotelManager/mail/goto#zhidao"; //自动跳转到锚点处
</script>
</head>
...
<body>
  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="icon-reorder"></i>群发邮件给我们的所有客户
      </div>
      <div class="widget-content padded">
        <form action="/HotelManager/mail/do" class="form-horizontal" method="post">
          
          
          <div class="form-group">
            <label class="control-label col-md-2">邮件标题</label>
            <div class="col-md-7">
