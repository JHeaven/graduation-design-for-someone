...
<html>
  <head>
    ...
    <script>
	window.location = "/HotelManager/room/all#zhidao"; //自动跳转到锚点处
</script>
  </head>
                ...
                <table class="table table-bordered table-striped" id="dataTable1">
                  ...
                  <c:forEach var="p" items="${allRoom}">
                    <tr>
                      ...
                      <td>
                        <a href="/HotelManager/room/update/${p.id}#zhidao" target="r"><span class="label label-info">修改房间</span></a><br>
                        <a href="/HotelManager/room/del/${p.id}#zhidao" target="r"><span class="label label-danger">删除房间</span></a>
                      </td>
