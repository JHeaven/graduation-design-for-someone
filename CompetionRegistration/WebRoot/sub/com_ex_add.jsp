...
<body>
	<div id="container" class="effect aside-float aside-bright mainnav-lg">
		<div class="boxed">
			...
			<form action="/CompetionRegistration/game/doAddEx" method="post">
				<!--Page Title-->
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<div id="page-title">
					<h1 class="page-header text-overflow">为竞赛【${com.name}】添加题目</h1>
										...
										<div class="col-sm-9">
											<div class="radio">
												<input id="demo-form-radio1" class="magic-radio"
													type="radio" name="ans" value="A"> <label
										...
										<div class="col-sm-9">
											<div class="radio">
												<input id="demo-form-radio2" class="magic-radio"
													type="radio" name="ans" value="B"> <label
										...
										<div class="col-sm-9">
											<div class="radio">
												<input id="demo-form-radio3" class="magic-radio"
													type="radio" name="ans" value="C"> <label
										...
										<div class="col-sm-9">
											<div class="radio">
												<input id="demo-form-radio4" class="magic-radio"
													type="radio" name="ans" value="D"> <label
				...
				<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">提交竞賽題目</h3>
								</div>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" placeholder="" id="demo-hor-inputemail"
												class="form-control" name="score">
										</div>
									</div>
									<div class="form-group">
										<button class="btn btn-success" type="submit">提交題目</button>
									</div>
								</div>
								<!--===================================================-->
								<!--End Horizontal Form-->
