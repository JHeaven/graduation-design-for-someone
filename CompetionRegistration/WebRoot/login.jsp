		...
		<div class="cls-content">
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            ...
		            <form action="/CompetionRegistration/login" method="post">
		        ...
		        <div class="pad-all">
		            ...
		            <a href="http://localhost:8080/CompetionRegistration/reg.jsp" class="btn-link mar-lft">创建一个新用户</a>
