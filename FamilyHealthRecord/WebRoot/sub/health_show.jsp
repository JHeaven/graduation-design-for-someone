...
<html>
 ...
 <div id="content" class="span12" style="width: 98%;height:100%;overflow:auto;">
				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<div class="form-actions">
								...
								<a class="btn btn-primary" onclick="notyText('${LoginFlage.loginName}，删除了档案！');" target="right" href="/FamilyHealthRecord/health-del.do?id=${r.id}">删除档案</a>
							  </div>
							</fieldset>
						  </form>
	...
	<script type="text/javascript">
		window.parent.frames.notyText("当前正在查看家人健康信息表！");
	</script>
  </body>
</html>
