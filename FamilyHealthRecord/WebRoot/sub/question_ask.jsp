			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 健康问题咨询</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="/FamilyHealthRecord/question-add.do">
							<fieldset>
							<table>
							<tr>
							<td>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <textarea class="cleditor" id="editor" rows="3" name="ask"></textarea>
								</div>
							  </div>
							</td>
							</tr>
