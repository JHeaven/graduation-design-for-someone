...
<html>
 ...
 <div id="content" class="span12" style="width: 98%">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#">健康知识发布</a> <span class="divider">/</span>
					</li>
					<li>
						<a href="#">发布</a>
					</li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 健康知识发布</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="/FamilyHealthRecord/news-add.do">
							<fieldset>
							<table>
							<tr>
							<td>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">文章内容</label>
								<div class="controls">
								  <textarea class="cleditor" id="editor" rows="3" name="content"></textarea>
								</div>
							  </div>
							</td>
							</tr>
