			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-plus"></i> 读懂自己的身体状况--白天篇</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-bordered table-striped">
							...
							<tr>
								<td><h3></h3></td>
								<td>
									<a href="#" class="btn btn-danger" data-rel="popover" data-content="除去用眼疲劳的原因外，看报时眼睛剧痛你就要小心青光眼了。" title="A.眼睛痛">A.眼睛痛</a><br><br>
									<a href="#" class="btn btn-danger" data-rel="popover" data-content="　拿书报时的手会发抖，可能是甲亢，也可能是帕金森氏病。" title="B.手发抖">B.手发抖</a><br><br>
									<a href="#" class="btn btn-danger" data-rel="popover" data-content="读书报时总是心不在焉，无法专心阅读，提示你心事重重，一定要去看心理医生了。" title="C.无法阅读">C.无法阅读</a>
								</td>
							</tr>
