	...
	<div class="container-fluid"
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<br>
					<div class="alert alert-info">请输入用户名密码后登陆。请留意用户名和密码的大小写。<p style="color: red;">${message}</p></div>
					<form class="form-horizontal" action="/FamilyHealthRecord/index-login.do" method="post">
						<fieldset>
							...
							<div class="input-prepend">
								<a href="/FamilyHealthRecord/reg.jsp">没有帐号？</a>
							</div>
							<div class="clearfix"></div>
